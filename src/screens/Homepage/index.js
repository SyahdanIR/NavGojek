    ...
    <View style={wallet.container}>
      <View
        ...
        <View style={wallet.debit}>
          <Text style={wallet.saldo}>Rp10.000</Text>
          <Text style={wallet.coin}>110 Coins</Text>
        </View>
      </View>
      <View
        style={{
      ...
      <View style={rating.horizontalCard}>
        ...
        <View style={{alignItems: 'center'}}>
          <View style={rating.content}>
            <Image source={scooter} style={rating.driver} />
            <View style={rating.description}>
              ...
              <Text style={rating.text}>Nasi Lemak - KFC</Text>
              <Text style={rating.text}>14 Des 11:12</Text>
            </View>
          </View>
